...
The `Core-SK-Scenarios` console application shows the final solution to the [Understanding the kernel](https://learn.microsoft.com/en-us/semantic-kernel/ai-orchestration/kernel) doc article.
